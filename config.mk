...
###########################################################################
SYSCALL_OBJS = syscall.o gettid.o exec.o fork.o set_status.o
...
syscall/thread_management.o syscall/_thread_management.o syscall/_consoleIO.o enter_user_mode.o memory/mem_mgmt.o \
process_thread/process.o process_thread/scheduler.o process_thread/thread.o \
syscall/life_cycle.o syscall/_life_cycle.o locks/atomic_xchange.o locks/spinlock.o \
process_thread/do_switch.o
